...
def speak(text, bool_access) :
    ...
    if bool_access == True :
        bool_access = False
        name = 'voice1.mp3'
        tts.save('C:\\Users\\kaout\\irisi4\\MA\\mp\\220522_2\\MSL\\'+name)
        playsound('C:\\Users\\kaout\\irisi4\\MA\\mp\\220522_2\\MSL\\'+name)
        os.remove('C:\\Users\\kaout\\irisi4\\MA\\mp\\220522_2\\MSL\\'+name)
        bool_access = True
    else :
        bool_access = True
        name = 'voice2.mp3'
...
while cap.isOpened():
    ...
    # if results.multi_hand_landmarks is not None:
        ...
        if cleaned_landmark:
            ...
            # thread.start_new_thread(speak,res)
            if res != res1 :
                # time.sleep(2).
                print(y_pred)
                res1 = res
                print(res1)
                th = threading.Thread(target=speak, args=(res,bool_access))
                th.start()
